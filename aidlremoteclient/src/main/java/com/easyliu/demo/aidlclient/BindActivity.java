package com.easyliu.demo.aidlclient;
...
public class BindActivity extends AppCompatActivity {
    ...
    private View.OnClickListener mBindListener = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            intent.setPackage("com.easyliu.demo.aidlservice");
            ...
            if (a) {
                ...
                mCallbackText.setText("Binding failed!");
            }
        }
    };
    /**
        ...
        public void onClick(View v) {
            ...
            if (mSecondaryService != null) {
                try {
                    ...
                    mSecondaryService.sendContract(3, "678");
                    Log.e("aidlclient", "send message");
    ...
    private IRemoteServiceCallback mCallback = new IRemoteServiceCallback.Stub() {
         ...
         */
        public void valueChanged(int type, String content) {
            mHandler.sendMessage(mHandler.obtainMessage(BUMP_MSG, type, 0));
            Log.e("suhao", content);
        }
    };
}
